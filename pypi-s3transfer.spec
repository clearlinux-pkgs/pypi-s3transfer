...
Source0  : https://files.pythonhosted.org/packages/fc/9e/73b14aed38ee1f62cd30ab93cd0072dec7fb01f3033d116875ae3e7b8b44/s3transfer-0.12.0.tar.gz
...
%prep
%setup -q -n s3transfer-0.12.0
cd %{_builddir}/s3transfer-0.12.0
pushd ..
cp -a s3transfer-0.12.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1745363932
