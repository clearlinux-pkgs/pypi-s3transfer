...
Source0  : https://files.pythonhosted.org/packages/82/e0/5f98a2974fa8c041848ff1acb657b50546ea1505fc1f50e3424120cee557/s3transfer-0.11.0.tar.gz
...
%prep
%setup -q -n s3transfer-0.11.0
cd %{_builddir}/s3transfer-0.11.0
pushd ..
cp -a s3transfer-0.11.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1737012765
