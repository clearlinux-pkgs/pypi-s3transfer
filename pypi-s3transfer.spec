...
Source0  : https://files.pythonhosted.org/packages/1a/aa/fdd958c626b00e3f046d4004363e7f1a2aba4354f78d65ceb3b217fa5eb8/s3transfer-0.11.1.tar.gz
...
%prep
%setup -q -n s3transfer-0.11.1
cd %{_builddir}/s3transfer-0.11.1
pushd ..
cp -a s3transfer-0.11.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1737075767
