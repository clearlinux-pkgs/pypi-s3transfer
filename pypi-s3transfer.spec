...
Source0  : https://files.pythonhosted.org/packages/7e/19/f82e4af435a19b28bdbfba63f338ea20a264f4df4beaf8f2ab9bfa34072b/s3transfer-0.5.2.tar.gz
...
%prep
%setup -q -n s3transfer-0.5.2
cd %{_builddir}/s3transfer-0.5.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1645804023
...
cp %{_builddir}/s3transfer-0.5.2/LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-s3transfer/2b8b815229aa8a61e483fb4ba0588b8b6c491890
