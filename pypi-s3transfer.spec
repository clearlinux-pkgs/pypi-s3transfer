...
Source0  : https://files.pythonhosted.org/packages/c4/2b/5c9562795c2eb2b5f63536961754760c25bf0f34af93d36aa28dea2fb303/s3transfer-0.11.5.tar.gz
...
%prep
%setup -q -n s3transfer-0.11.5
cd %{_builddir}/s3transfer-0.11.5
pushd ..
cp -a s3transfer-0.11.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744993922
