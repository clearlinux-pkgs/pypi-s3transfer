...
Source0  : https://files.pythonhosted.org/packages/83/bc/fb0c1f76517e3380eb142af8a9d6b969c150cfca1324cea7d965d8c66571/s3transfer-0.10.1.tar.gz
...
%prep
%setup -q -n s3transfer-0.10.1
cd %{_builddir}/s3transfer-0.10.1
pushd ..
cp -a s3transfer-0.10.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710541935
