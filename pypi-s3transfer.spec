...
Source0  : https://files.pythonhosted.org/packages/6d/05/d52bf1e65044b4e5e27d4e63e8d1579dbdec54fce685908ae09bc3720030/s3transfer-0.13.1.tar.gz
...
%prep
%setup -q -n s3transfer-0.13.1
cd %{_builddir}/s3transfer-0.13.1
pushd ..
cp -a s3transfer-0.13.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1753109698
