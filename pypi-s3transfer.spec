...
Source0  : https://files.pythonhosted.org/packages/c0/0a/1cdbabf9edd0ea7747efdf6c9ab4e7061b085aa7f9bfc36bb1601563b069/s3transfer-0.10.4.tar.gz
...
%prep
%setup -q -n s3transfer-0.10.4
cd %{_builddir}/s3transfer-0.10.4
pushd ..
cp -a s3transfer-0.10.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1732152994
