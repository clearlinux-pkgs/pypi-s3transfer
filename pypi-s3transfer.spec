...
Source0  : https://files.pythonhosted.org/packages/ed/5d/9dcc100abc6711e8247af5aa561fc07c4a046f72f659c3adea9a449e191a/s3transfer-0.13.0.tar.gz
...
%prep
%setup -q -n s3transfer-0.13.0
cd %{_builddir}/s3transfer-0.13.0
pushd ..
cp -a s3transfer-0.13.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747947218
