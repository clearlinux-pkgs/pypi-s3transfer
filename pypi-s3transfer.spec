...
Provides: s3transfer
Provides: s3transfer-python
Provides: s3transfer-python3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1641492288
...
cp %{_builddir}/s3transfer-0.5.0/LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-s3transfer/5a7d7df655ba40478fae80a6abafc6afc36f9b6a
...
/usr/share/package-licenses/pypi-s3transfer/5a7d7df655ba40478fae80a6abafc6afc36f9b6a
